...
*/
    ...
    private void setPlayersScore() {
        ...
        // Preneur a Gagné
        if (getResult() == true) {
            boolean fourIsTrue = false, fiveIsTrue = false;
            ...
            switch (nbJoueur) {
                ...
                case 5:
                    ...
                    {
                        setScorePlayer5Winner(scoreDonne);
                    }
                ...
                case 4:
                    ...
                    {
                        setScorePlayer4Winner(scoreDonne, fiveIsTrue);
                    }
                ...
                case 3:
                    ...
                    {
                        setScorePlayer3Winner(scoreDonne, fiveIsTrue, fourIsTrue);
                    }

                    // Joueur 2 est preneur
                    if (preneur.equals(player2.getNomJoueur()))
                    {
                        setScorePlayer2Winner(scoreDonne, fiveIsTrue, fourIsTrue);
                    }

                    // Joueur 1 est preneur
                    if (preneur.equals(player1.getNomJoueur()))
                    {
                        setScorePlayer1Winner(scoreDonne, fiveIsTrue, fourIsTrue);
                    }
                    break;
            }
        ...
        // Preneur a perdu
            ...
            switch (nbJoueur) {
                ...
                case 5:
                    ...
                    if(preneur.equals(player5.getNomJoueur()))
                    {
                        setScorePlayer5Looser(scoreDonne);
                    }
                ...
                case 4:
                    ...
                    if (preneur.equals(player4.getNomJoueur()))
                    {
                        setScorePlayer4Looser(scoreDonne, fiveIsTrue);
                    }
                ...
                case 3:
                    ...
                    if (preneur.equals(player3.getNomJoueur()))
                    {
                        setScorePlayer3Looser(scoreDonne, fiveIsTrue, fourIsTrue);
                    }

                    // Joueur 2 est preneur
                    if (preneur.equals(player2.getNomJoueur()))
                    {
                        setScorePlayer2Looser(scoreDonne, fiveIsTrue, fourIsTrue);
                    }

                    // Joueur 1 est preneur
                    if (preneur.equals(player1.getNomJoueur()))
                    {
                        setScorePlayer1Looser(scoreDonne, fiveIsTrue, fourIsTrue);
                    }
                    break;
            }
        }
        ...
        while(size > 0)
        {
            ...
            switch(nbJoueur)
            {
                ...
                case 5:
                    ...
                    if(playerList.get(i) == player5.getNomJoueur())
                    {
    ...
    private void setScorePlayer5Winner(int scoreDonne)
    {
    ...
    private void setScorePlayer4Winner(int scoreDonne, boolean fiveIsTrue)
    {
            if(fiveIsTrue)
            {
                // Joueur 5 associé
    ...
    private void setScorePlayer3Winner(int scoreDonne, boolean fiveIsTrue, boolean fourIsTrue)
    {
        if(fiveIsTrue)
        {
            // Joueur 5 associé
    ...
    private void setScorePlayer2Winner(int scoreDonne, boolean fiveIsTrue, boolean fourIsTrue)
    {
        if(fiveIsTrue)
        {
            // Joueur 5 associé
    ...
    private void setScorePlayer1Winner(int scoreDonne, boolean fiveIsTrue, boolean fourIsTrue)
    {
        if(fiveIsTrue)
        {
            // Joueur 5 associé
    ...
    private void setScorePlayer5Looser(int scoreDonne)
    {
    ...
    private void setScorePlayer4Looser(int scoreDonne, boolean fiveIsTrue)
    {
        if(fiveIsTrue)
        {
            // Joueur 5 associé
    ...
    private void setScorePlayer3Looser(int scoreDonne, boolean fiveIsTrue, boolean fourIsTrue)
    {
        if(fiveIsTrue)
        {
            // Joueur 5 associé
    ...
    private void setScorePlayer2Looser(int scoreDonne, boolean fiveIsTrue, boolean fourIsTrue)
    {
        if(fiveIsTrue)
        {
            // Joueur 5 associé
    ...
    private void setScorePlayer1Looser(int scoreDonne, boolean fiveIsTrue, boolean fourIsTrue)
    {
        if(fiveIsTrue)
        {
            // Joueur 5 associé
